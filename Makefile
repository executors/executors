...
wording_pdf: wording_front_matter.md wording.md
	pandoc wording_front_matter.md wording.md -o wording.pdf -H header.tex --number-sections -o P0443R11_A_Unified_Executors_Proposal.pdf

wording_html: wording.md
	pandoc --standalone wording_front_matter.md wording.md -o wording.html --number-sections -o P0443R11_A_Unified_Executors_Proposal.html
...
dependent_wording_html: dependent_wording.md
	pandoc --standalone dependent_wording_front_matter.md dependent_wording.md -o dependent_wording.html --number-sections -o P1244R0_Dependent_Executor_for_a_Unified_Executors_Proposal.html
...
explanatory_html: explanatory.md explanatory_header.tex explanatory_metadata.yaml
	pandoc --standalone $(PANDOC_FLAGS) $(CITEPROC) -H explanatory_header.tex explanatory_metadata.yaml explanatory.md -o P0761R3_Executors_Design_Document.html
