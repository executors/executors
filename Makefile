...
wording: front_matter.md design.md wording.md appendices.md P0443-syntax.xml Makefile
	pandoc --standalone -Vlinkcolor:blue --syntax-definition=P0443-syntax.xml --highlight-style=haddock --number-sections front_matter.md design.md wording.md appendices.md -o D0443R14_A_Unified_Executors_Proposal.html
