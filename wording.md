...
In the Table below,
  ...
  * `val` denotes any object stored in `fut`'s associated shared state when it becomes ready and nonexceptional,
  * `e` denotes the object stored in `fut`'s associated shared state when it becomes ready and exceptional,
