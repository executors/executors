...
static_assert(execution::is_bulk_twoway_executor_v<decltype(execution::require(execution::require(
          inline_executor(), execution::bulk), execution::unsafe_mode, execution::twoway))>, "bulk two way executor requirements not met");
static_assert(execution::is_bulk_twoway_executor_v<decltype(execution::require(execution::require(
          inline_executor(), execution::unsafe_mode, execution::twoway), execution::bulk))>, "bulk two way executor requirements not met");

int main()
{
  inline_executor ex1;

  auto ex2 = execution::require(execution::require(ex1, execution::bulk), execution::unsafe_mode, execution::twoway);
  ...
  auto ex3 = execution::require(execution::require(ex1, execution::unsafe_mode, execution::twoway), execution::bulk);
